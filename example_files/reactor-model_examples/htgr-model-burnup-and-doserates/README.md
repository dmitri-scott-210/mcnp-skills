...
Navigate to https://nstopenresearch.org/articles/1-20/v2 to read and gain context for this project repository.

---

## Article Summarized Contexts

### Verification

The section “Verification” introduces a verification exercise consisting of the delayed heating calculation of a simple geometry. 

### TRISO-fueled Advanced Gas Reactor 1 (AGR-1)

The section “AGR-1” discusses an exercise studying the shutdown-dose rates of the TRISO-fueled Advanced Gas Reactor 1 (AGR-1) experiment.

The AGR-1 was a TRISO-particle irradiation test in the ATR, a 250-MWth high flux test reactor located at the Reactor Technology Complex of the INL. This experiment was part of the DOE Advanced Gas Reactor Fuel Development and Qualification Program to support the NGNP program.

### Micro

The section “μHTGR” investigates a decommissioning strategy for a high-temperature gas-cooled microreactor from a shutdown-dose rate standpoint.

---

# Project Repo Configuration and Contents
